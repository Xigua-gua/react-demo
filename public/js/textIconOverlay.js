...
(function () {
    ...
    */
    TextIconOverlay.prototype._updateText = function(){
        if (this._domElement) {
          if (this._text.name === '全部') {
            this._domElement.innerHTML= null
          }else {
              ...
              <div style="
                ...
                >
                  <span style="
                    ...
                    left:80px;
                    bottom:-40px;
                    width:0; height:0; font-size:0; overflow:hidden; position:absolute;"></span>
                  <span style="
                    border-width: 20px;
                    border-style: solid dashed dashed;
                  ...
                  ${this._text.name} ${this._text.value}
              </div>
              `
          }
        }
