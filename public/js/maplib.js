...
(function(){
    ...
    var MarkerClusterer =
         ...
         *    markersText {Array}要聚合的标记数组内的信息<br />
        ...
        BMapLib.MarkerClusterer = function(map, options){
            ...
            var opts = options || {};
            this.clustererTitle = opts["title"]
            this._markersData = opts["markersData"]; // 所有点位对应的数据
     ...
     * @return {String} 网格大小
     */
    MarkerClusterer.prototype.getClustererTitle = function() {
        return this.clustererTitle;
    };
     ...
     * @return {Array}
     */
    MarkerClusterer.prototype.getMarkersData = function() {
    ...
    function Cluster(markerClusterer){
        this.markers = markerClusterer.getMarkers()
        this.markersData = markerClusterer.getMarkersData()
    ...
    //     var index = indexOf(marker, this.markers)
    //     //获取marker的坐标
    //     var position = marker.getPosition();
    //     //创建label
    ...
    //         fontWeight : 'bold',
    //     });
    //     var content = `<img style="width: 30px;height: 30px;" src='../img/labelbar.png'/>`
    //     // var content = `
    //     //   <p style="
    //     //     position: relative;
    //     //     padding: 0px 30px;
    ...
    //     //       position: absolute;"
    //     //       ></span>
    //     //       ${this.markersData[index].name}
    //     //       <span
    //     //         style="
    //     //         padding-left: 10px;
    //     //         "
    //     //         >${this.markersData[index].total}单<span>
    //     //   </p>
    //     //   <img style="width: 30px;height: 30px;" src='../img/labelbar.png'/>
    //     // `;
    ...
    Cluster.prototype.updateClusterMarker = function () {
        ...
        this._clusterMarker.setText({name : this._markerClusterer.getClustererTitle() , value : this._markers.length});
